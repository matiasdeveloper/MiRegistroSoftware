...
namespace LayerPresentation
{
    public partial class frm_login : Form
    {
        ...
        private void RememberUser()
        {
            ...
            {
                Properties.Settings.Default.user = PasswordEncrypter.Encrypt(txtBox_user.Text);
                Properties.Settings.Default.pass = PasswordEncrypter.Encrypt(txtBox_pass.Text);
                Properties.Settings.Default.Save();
            }
            else
            {
                if (PasswordEncrypter.Decrypt(Properties.Settings.Default.user) == txtBox_user.Text)
                {
        ...
        private void FindSavedUser()
        {
            ...
            {
                txtBox_user.Text = PasswordEncrypter.Decrypt(Properties.Settings.Default.user);
                txtBox_pass.Text = PasswordEncrypter.Decrypt(Properties.Settings.Default.pass);
