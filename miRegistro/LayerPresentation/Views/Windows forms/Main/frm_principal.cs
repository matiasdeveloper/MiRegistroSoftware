...
namespace LayerPresentation
{
    public partial class frm_principal :  Form // Hereda de system.windows.form
    {
        ...
        {
            /*lbl_nombre.Text = UserLoginCacheOld.Nombre;
            lbl_email.Text = UserLoginCacheOld.Priveleges;
            lbl_lastacess.Text = UserLoginCacheOld.Fecha_UltimoAcceso.ToShortDateString();*/
        }
