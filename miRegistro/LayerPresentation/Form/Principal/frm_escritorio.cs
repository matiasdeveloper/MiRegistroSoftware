...
namespace LayerPresentation
{
    public partial class frm_escritorio : Form
    {
        ...
        {
            int v = (int)Math.Round(Utilities.CalculatePercentage(total, stockbajo), MidpointRounding.AwayFromZero);
        ...
        */
        ...
        {
            btn_chart_tramitesfinalizados.IdleForecolor = Color.LightGray;
            btn_chart_tramitesprocesados.IdleForecolor = Color.LightGray;
            btn_chart_tramitesinscriptos.IdleForecolor = Color.FromArgb(1, 171, 65, 43);
        }
        private void btn_chart_tramitesprocesados_Click(object sender, EventArgs e)
        {
            btn_chart_tramitesfinalizados.IdleForecolor = Color.LightGray;
            btn_chart_tramitesprocesados.IdleForecolor = Color.FromArgb(1, 171, 65, 43);
            btn_chart_tramitesinscriptos.IdleForecolor = Color.LightGray;
        }
        private void btn_chart_tramitesfinalizados_Click(object sender, EventArgs e)
        {
            btn_chart_tramitesfinalizados.IdleForecolor = Color.FromArgb(1, 171, 65, 43);
            btn_chart_tramitesprocesados.IdleForecolor = Color.LightGray;
            btn_chart_tramitesinscriptos.IdleForecolor = Color.LightGray;
        }
